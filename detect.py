"""Three-signal detection for Claude Code sessions killed by internet loss."""
...
def evaluate(jsonl_info, pane_class, loss_at, window_secs=30 * 60):
    """Return (decision, reasons). Resume only when all three signals agree."""
    reasons = []
    if not jsonl_info:
